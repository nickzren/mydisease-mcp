...
def find_python_executable():
    ...
    if hasattr(sys, 'real_prefix') or (hasattr(sys, 'base_prefix') and sys.base_prefix != sys.prefix):
        ...
        try:
            import mydisease_mcp
            return python_path
        except ImportError:
            print("Error: mydisease-mcp package not found in the current environment.", file=sys.stderr)
...
def test_server():
    ...
    try:
        import mydisease_mcp.server
        print("✅ Server module imported successfully")
        return True
    except ImportError as e:
        print(f"Error: Failed to import mydisease_mcp.server: {e}", file=sys.stderr)
